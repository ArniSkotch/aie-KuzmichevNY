...
DecisionTree,0.84,0.66,0.84
RandomForest,0.87,0.68,0.91
HistGradientBoosting,0.90,0.79,0.92

Победитель: HistGradientBoostingClassifier. Модель показала лучший ROC-AUC, так как она эффективно справляется с нелинейными взаимодействиями признаков, которые заложены в датасете №2.
